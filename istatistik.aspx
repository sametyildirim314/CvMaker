<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="istatistik.aspx.cs" Inherits="CVapp.WebForm8" %>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <div class="skills-top">
            ...
            <div class="clearfix"></div>
            <div class="skills">
                <div class="skill2" style="width:96%"></div>
            </div>
        </div>
        <p> CV WEB SİTESİ  projemizin admin paneli kısmındasınız.</p>
    </div>
    <div class="clearfix"></div>
</div>
